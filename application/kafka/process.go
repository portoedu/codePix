...
import (
	...
	"github.com/portoedu/codePix/application/factory"
	appmodel "github.com/portoedu/codePix/application/model"
...
func (k *KafkaProcessor) processMessage(msg *ckafka.Message) {
	...
	default:
		fmt.Println("topico nao aceito", string(msg.Value))
	}
}
